  ...
  <div class="home">
    <section class="gradient-backgroud py-5">
      <div class="container text-center text-white">
        <div class="py-5">
          <h1 class="display-3 fw-bold mb-4">Welcome to <span class="brand-logo">TickTokTwo</span> Auctions</h1>
          ...
          <div class="d-flex justify-content-center align-items-center gap-4 mb-4 flex-wrap">
            ...
            <router-link v-if="isLoggedIn" to="/create-item" class="text-decoration-none">
              <Button text="List Your Watch" />
            </router-link>
            <router-link v-else to="/register" class="text-decoration-none">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-12 text-center">
            <h2 class="display-5 fw-bold text-dark">Brands</h2>
          </div>
        </div>
        <div class="row g-3">
